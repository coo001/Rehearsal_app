...
PARSE_SCRIPT_SYSTEM = """당신은 연극 대본 분석 전문가입니다. 주어진 대본을 분석하여 구조화된 JSON으로 반환하세요.
...
반환 형식:
{
  ...
  "character_descriptions": {
    "캐릭터1": "이 인물이 어떻게 말하는지 — 말투, 태도, 발화 습관 중심으로 1문장. 직업·나이보다 목소리에서 느껴지는 특성 위주.",
    "캐릭터2": "..."
  },
  "lines": [
    {
      ...
      "intensity": 2,
      "tempo": "보통",
      "subtext": "배우가 이 순간 실제로 원하는 것, 짧은 동사구로 (예: '이 대화를 빨리 끝내고 싶다', '상대가 먼저 물러나길 원한다', '실수를 들키지 않으려 한다'). 심리 분석 금지. 없으면 null.",
