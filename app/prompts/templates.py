...
작업 순서: 반드시 character_analysis를 먼저 완성한 뒤, 그 결과를 참조하여 각 대사의 subtext와 tts_direction을 생성하세요.
...
반환 형식:
{
  ...
  "character_analysis": {
    "캐릭터1": {
      ...
      "relational_pattern": "관계에서 이 인물이 취하는 방식. 예: '상대를 시험한 뒤에야 믿는다' / '가까워질수록 먼저 밀어낸다' / '상대가 강하면 복종하고, 약하면 통제한다'",
...
- subtext는 반드시 character_analysis를 근거로, beat_goal과 달라야 함
